...
const ReturnPolicyPage = () => {
  ...
  const countries = [
    'Brasil', 'Estados Unidos', 'Reino Unido', 'Alemanha', 'França', 
    'Espanha', 'Itália', 'Portugal', 'Canadá', 'Austrália', 
    'Japão', 'China', 'Índia', 'México', 'Chile', 
    'Argentina', 'Colômbia'
  ];
  ...
  const faqs = [
    {
      ...
      answer: 'Para iniciar o processo de devolução, acesse sua conta em nosso site, localize o pedido que deseja devolver e clique em "Solicitar Devolução". Preencha o formulário explicando o motivo da devolução e siga as instruções para envio do produto ao nosso centro de distribuição.'
    },
    {
      question: 'Quais produtos não são elegíveis para devolução?',
      answer: 'Produtos personalizados, itens íntimos, alimentos, medicamentos, software/licenças digitais, produtos com lacre rompido, itens com desconto especial marcados como "venda final" e qualquer produto proibido pela legislação alfandegária não são elegíveis para devolução.'
    },
    {
      question: 'Como funcionam os reembolsos?',
      answer: 'Após recebermos e verificarmos o produto devolvido, processaremos o reembolso no mesmo método de pagamento utilizado na compra. O valor será creditado descontando as taxas de devolução aplicáveis. O tempo de processamento varia de acordo com a instituição financeira, geralmente entre 3-15 dias úteis.'
    },
    {
      question: 'O que acontece se meu produto chegar danificado ao destino?',
      answer: 'Se seu produto chegar danificado ao comprador final, você deve notificar nossa equipe em até 48 horas após o recebimento, enviando fotos detalhadas do dano. Nossa equipe analisará o caso e, se confirmado o dano durante o transporte, processaremos o reembolso sem custos adicionais ou organizaremos uma substituição, dependendo da disponibilidade.'
    },
    {
      question: 'Posso devolver apenas parte do meu pedido?',
      answer: 'Sim, é possível devolver apenas parte dos itens de um pedido. Cada item será avaliado individualmente, e as taxas de devolução serão calculadas por item. O processo funciona da mesma forma que uma devolução completa, mas você deve especificar exatamente quais itens estão sendo devolvidos.'
    },
    {
      question: 'Como são calculadas as taxas de devolução internacional?',
      answer: 'As taxas de devolução internacional são calculadas com base no país de origem, país de destino, dimensões e peso do pacote, além de possíveis taxas alfandegárias. A taxa básica cobre os custos de logística reversa e processamento. Taxas adicionais podem ser aplicadas para itens volumosos ou quando há necessidade de documentação especial.'
    }
  ];
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-8">
              ...
              <div className="border-l-4 border-blue-500 pl-4 mb-6">
                <p className="italic text-gray-700">
                  "Nosso compromisso é proporcionar uma experiência de devolução tão satisfatória quanto a de compra."
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg mb-6">
                ...
                <ul className="list-disc pl-5 space-y-1">
                  <li><span className="font-medium">Produtos padrão:</span> {returnDeadlines.standard} dias após o recebimento</li>
                  <li><span className="font-medium">Produtos específicos (eletrônicos, itens de luxo):</span> {returnDeadlines.extended} dias após o recebimento</li>
                  <li><span className="font-medium">Devoluções por defeito de fabricação:</span> {returnDeadlines.international} dias após o recebimento</li>
                </ul>
              </div>
              ...
              <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6">
                <p className="text-yellow-800">
                  <span className="font-bold">Observação:</span> As taxas podem variar dependendo do país de origem e destino. 
                  Use nosso seletor de país para obter informações específicas para sua região.
                </p>
              </div>
              ...
              {selectedCountry && (
                <div className="mt-4 p-3 bg-gray-50 rounded-md">
                  ...
                  <p className="text-sm mt-2">
                    As políticas gerais se aplicam a {selectedCountry}, com possíveis 
                    variações devido à legislação local e acordos de importação específicos. 
                    Para detalhes completos, por favor entre em contato com nosso suporte.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center">
                  ...
                  <span>suporte@suaempresa.com</span>
                </div>
                <div className="flex items-center">
                  <svg className="w-5 h-5 text-blue-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
