...
export default function DashboardClient({ initialUserData, lang }: DashboardClientProps) {
  const {
    language,
    setLanguage,
    currency,
    ...
    setSelectedCountry,
    t,
  } = useDashboard({ initialUserData, lang });
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2">
              <div className="bg-blue-200 text-blue-800 font-bold rounded-full w-8 h-8 flex items-center justify-center">
                {initialUserData.name.charAt(0) || '?'}
              </div>
              <span className="font-semibold text-blue-800">{initialUserData.name}</span>
            </div>
          </div>
        </div>
      </header>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-blue-100 overflow-hidden">
              <div className="bg-blue-600 text-white p-6 flex items-center justify-between">
                <div>
                  ...
                  <div className="text-2xl font-bold">{initialUserData.suite}</div>
                  <div className="mt-1">{initialUserData.name}</div>
                </div>
            ...
            <div className="mb-6">
              ...
              <UserAddress
                address={{
                    ...
                    zipCode: initialUserData.address.postalCode, // Aqui convertemos postalCode para zipCode
                }}
                suiteNumber={initialUserData.suite}
