  ...
  const consolidatePackages = () => {
    if (selectedPackages.length > 0) {
      ...
      setTimeout(() => {
        setPackages((prev) =>
          prev.map((pkg) =>
            selectedPackages.includes(pkg.id) ? { ...pkg, status: "consolidated" } : pkg
          )
        );
        setSelectedPackages([]);
      ...
      <div className="bg-white p-8 rounded-lg shadow-xl max-w-md w-full">
        <div className="flex flex-col items-center">
          ...
          <p className="text-gray-600 text-center">
            Estamos preparando seus produtos para envio em um único pacote...
          </p>
    ...
    <div className="relative w-full h-64 md:h-96 bg-gradient-to-br from-blue-100 to-indigo-100 rounded-xl overflow-hidden mb-8">
      <div className="absolute inset-0 opacity-20">
        <svg viewBox="0 0 1000 500" className="w-full h-full">
          <path
            d="M250,100 C300,80 350,90 400,100 C450,110 500,130 550,120 C600,110 650,90 700,100 C750,110 800,130 850,120"
            fill="none"
            stroke="#333"
            strokeWidth="3"
          ...
          />
          <path
            d="M200,200 C250,180 300,190 350,200 C400,210 450,230 500,220 C550,210 600,190 650,200 C700,210 750,230 800,220"
            fill="none"
            stroke="#333"
            strokeWidth="3"
            className="animate-pulse"
          />
          <path
            d="M300,300 C350,280 400,290 450,300 C500,310 550,330 600,320 C650,310 700,290 750,300"
            fill="none"
            stroke="#333"
            strokeWidth="3"
            className="animate-pulse"
      ...
      {countries.map((country, idx) => (
        <div
          key={country.id}
          className={`absolute w-6 h-6 rounded-full flex items-center justify-center cursor-pointer transition-all duration-300 hover:scale-125 ${
            selectedOrigin === country.code ? "bg-purple-600" : "bg-blue-500"
          }`}
          style={{
    ...
    <div className="min-h-screen bg-gradient-to-br from-white to-blue-50">
      ...
      <main className="container mx-auto py-8 px-4">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Compre em lojas internacionais e envie para nossos armazéns em qualquer um dos 17 países.
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Combinamos todos os seus pacotes em um único envio, otimizando espaço e reduzindo custos.
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Enviamos seu pacote consolidado para qualquer lugar do mundo com rastreamento completo.
                    </p>
                  </div>
                </div>
              </div>
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {packages.map((pkg) => (
                        <tr key={pkg.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{pkg.arrivalDate}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
        ...
        <section className="mt-12 mb-12">
          <h2 className="text-2xl font-bold mb-8 text-center">Benefícios da Consolidação Internacional</h2>
            ...
            <div className="divide-y divide-gray-200">
              <div className="p-6">
                <h3 className="text-lg font-medium text-blue-800 mb-2">
                  Quanto tempo leva para consolidar meus pacotes?
                </h3>
                <p className="text-gray-600">
                  A consolidação ocorre em até 24 horas após a chegada do último pacote em nosso armazém. Após a
                  confirmação de consolidação, o envio internacional é processado em até 48 horas.
                </p>
              </div>
              <div className="p-6">
                <h3 className="text-lg font-medium text-blue-800 mb-2">
                  Posso consolidar pacotes de diferentes países?
                </h3>
                <p className="text-gray-600">
                  Sim! Você pode consolidar pacotes de diferentes países, mas eles precisam estar no mesmo centro de
                  distribuição. Oferecemos a opção de transferência entre centros com custo adicional.
                </p>
              </div>
              <div className="p-6">
                <h3 className="text-lg font-medium text-blue-800 mb-2">
                ...
                <p className="text-gray-600">
                  O cálculo é baseado no peso dimensional e real do pacote consolidado, além do país de destino. Nossa
                  tecnologia otimiza a embalagem para garantir o melhor preço possível.
                </p>
              </div>
              <div className="p-6">
                <h3 className="text-lg font-medium text-blue-800 mb-2">
                  Existe um limite de tempo para armazenar meus pacotes?
                </h3>
                <p className="text-gray-600">
                  Oferecemos 90 dias gratuitos de armazenamento. Após esse período, uma pequena taxa diária será
                  aplicada. Recomendamos a consolidação dentro desse prazo para evitar custos adicionais.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-12 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl p-8 text-center">
          ...
          <p className="mb-6 max-w-2xl mx-auto">
            Crie sua conta gratuita agora e receba seu endereço de entrega em 17 países. Consolidação inteligente para
            economia no frete internacional.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600 italic">
                Economizei mais de R$ 500 em um único envio consolidando 5 pacotes dos EUA. O processo foi muito simples
                e o suporte excelente!
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg">
              <div className="flex items-center mb-4">
              ...
              <p className="text-gray-600 italic">
                Compro regularmente eletrônicos da China e Japão. A consolidação me permite receber tudo de uma vez,
                pagando apenas um imposto de importação.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg">
              <div className="flex items-center mb-4">
              ...
              <p className="text-gray-600 italic">
                O sistema de rastreamento é excelente! Consigo acompanhar cada pacote e depois o envio consolidado em
                tempo real. Recomendo muito.
              </p>
            </div>
          </div>
        </section>
